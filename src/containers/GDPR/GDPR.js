    ...
    const texts = [
        {
            ...
            headerLeft: 'Allgemeine Informationen zur Datenverarbeitung',
        ...
        },
        {
            ...
            headerRight: 'Ihre Rechte / Rechte des Betroffenen'
        }
    ]
return (
    <>
    <Header size='huge' textAlign='center'>Datenschutz</Header>
    <Grid container columns={2} centered className={classes.GDPRGrid}>
        {texts.map(text =>
            <Grid.Row>
         ...
         <Button color='teal' as={Link} to="/kontakt">
            Zurück
        </Button>
